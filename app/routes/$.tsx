    ...
    <div className="min-h-screen bg-[#0F172A] text-white flex flex-col items-center justify-center p-8 font-sans overflow-hidden relative">
      ...
      <div className="relative z-10 text-center space-y-6 max-w-lg">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link to="/search" className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-3 font-bold uppercase text-xs tracking-widest transition-all hover:scale-105 flex items-center justify-center">
            Re-Initialize Radar
          </Link>
          <Link to="/" className="border border-white/20 hover:border-white/40 bg-transparent px-8 py-3 font-bold uppercase text-xs tracking-widest transition-all text-slate-300 hover:text-white flex items-center justify-center">
            Return to Base
          </Link>
        </div>
      </div>
